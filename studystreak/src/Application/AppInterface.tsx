...
export function Header() {
  return (
    <header className="w-full bg-white dark:bg-[#0A1220] backdrop-blur-xl text-slate-800 dark:text-white p-4 mb-4 shadow-sm dark:shadow-none transition-colors duration-200">
      <div className="container mx-auto flex justify-between items-center px-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <button className="btn-ghost p-2 relative">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-slate-600 dark:text-white/70" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export function SideBar() {
  return (
    <aside className="w-72 hidden md:block bg-gray-50 dark:bg-[#0A1220]/80 backdrop-blur-xl text-slate-800 dark:text-white h-full border-r border-gray-200 dark:border-white/5 transition-colors duration-200">
            ...
            <NavLink to="/dashboard" 
              className={({ isActive }) => `
                ...
                ${isActive 
                  ...
                  : 'text-slate-600 dark:text-white/70 hover:bg-gray-100 dark:hover:bg-white/5'}
              `}
            >
              <IconContainer>
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-slate-500 dark:text-white/70 group-[.active]:text-blue-500 dark:group-[.active]:text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs text-slate-500 dark:text-white/50">Overview & Stats</span>
              </div>
            </NavLink>
          </li>
          <li>
            ...
            >
              <IconContainer>
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-slate-500 dark:text-white/70 group-[.active]:text-green-500 dark:group-[.active]:text-green-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs text-slate-500 dark:text-white/50">Your Progress</span>
              </div>
            </NavLink>
          </li>
          <li>
            ...
            >
              <IconContainer>
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-slate-500 dark:text-white/70 group-[.active]:text-amber-500 dark:group-[.active]:text-amber-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs text-slate-500 dark:text-white/50">Preferences</span>
              </div>
            </NavLink>
          </li>
          <li>
            ...
            >
              <IconContainer>
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-slate-500 dark:text-white/70 group-[.active]:text-red-500 dark:group-[.active]:text-red-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              </IconContainer>
              <div className="flex flex-col">
                <span className="font-medium">Pomodoro</span>
                <span className="text-xs text-slate-500 dark:text-white/50">Focus Timer</span>
              </div>
            </NavLink>
          </li>
          <li>
            ...
            >
              <IconContainer>
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-slate-500 dark:text-white/70 group-[.active]:text-purple-500 dark:group-[.active]:text-purple-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                </svg>
              </IconContainer>
              <div className="flex flex-col">
                <span className="font-medium">Courses</span>
                <span className="text-xs text-slate-500 dark:text-white/50">Your Learning</span>
              </div>
            </NavLink>
          </li>
          <li>
            ...
            >
              <IconContainer>
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-slate-500 dark:text-white/70 group-[.active]:text-indigo-500 dark:group-[.active]:text-indigo-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" />
                </svg>
              </IconContainer>
              <div className="flex flex-col">
                <span className="font-medium">Todo List</span>
                <span className="text-xs text-slate-500 dark:text-white/50">Track Tasks</span>
              </div>
            </NavLink>
          </li>
        </ul>
