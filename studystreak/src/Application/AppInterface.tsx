...
export function Header() {
  return (
    <header className="w-full bg-[#0A1220]/80 backdrop-blur-xl text-white p-4 mb-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-8">
            ...
            <div className="hidden md:flex items-center gap-6 text-sm">
              <button className="text-white/70 hover:text-white transition-colors">Browse</button>
              <button className="text-white/70 hover:text-white transition-colors">Library</button>
              <button className="text-white/70 hover:text-white transition-colors">Recent</button>
            </div>
          </div>
        </div>
        <div className="flex items-center gap-4">
          <button className="p-2 hover:bg-white/5 rounded-lg transition-all duration-200 relative">
